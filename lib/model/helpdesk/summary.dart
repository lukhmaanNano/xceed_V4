...
class HelpdeskSummary extends StatefulWidget {
  ...
  @override
  State<HelpdeskSummary> createState() => _HelpdeskSummaryState();
}

class _HelpdeskSummaryState extends State<HelpdeskSummary> {
  ...
  Future<void> monthStatus() async {
    ...
    if (response.statusCode == 400) {
      ...
      var result = map['MonthStatus']['Total'];
      var result1 = map['MonthStatus']['Closed'];
      var result2 = map['MonthStatus']['Open'];
  ...
  Future<void> dayStatus() async {
    ...
    const json =
        '{"data":{"CountryID_varchar":0,"CustomerID_varchar":0,"ContractID_varchar":0,"LocationGroupID_varchar":0,"LocalityID_varchar":0,"BuildingID_varchar":0,"CityID_varchar":0,"FloorID_varchar":0,"SpotID_varchar":0,"DivisionID_varchar":0,"DisciplineID_varchar":0,"ServiceTypeID_varchar":0,"FromDate_datetime":"2022-11-01","ToDate_datetime":"2022-11-07","LocUserID_int":"6","PortalUserID_bit":0}}';
    final response =
        await http.post(url, headers: headers, body: json.toString());
    if (response.statusCode == 400) {
      String err = 'something went wrong!';
      ...
      var decodedJson = jsonDecode(jsonString);
      Map<String, dynamic> map = jsonDecode(decodedJson);
      var result = map['DayStatus']['Total'];
      var result1 = map['DayStatus']['Closed'];
      var result2 = map['DayStatus']['Open'];
      for (Map<String, dynamic> i in result) {
  ...
  Future<void> chartTappedDataTable() async {
    ...
    final json =
        '{"data":{"CountryID_varchar":0,"CustomerID_varchar":0,"ContractID_varchar":0,"LocationGroupID_varchar":0,"LocalityID_varchar":0,"BuildingID_varchar":0,"CityID_varchar":0,"FloorID_varchar":0,"SpotID_varchar":0,"DivisionID_varchar":0,"DisciplineID_varchar":0,"ServiceTypeID_varchar":0,"FromDate_datetime":"2023-02-27","ToDate_datetime":"2023-02-27","LocUserID_int":"6","PortalUserID_bit":0,"HeaderID_int":41,"DataParam_varchar":"2023-02-24","PageIndex_int":1,"PageSize_int":10,"ResultCount_int":null}}';
    final response =
        await http.post(url, headers: headers, body: json.toString());
    if (response.statusCode == 400) {
      String err = 'something went wrong!';
    ...
    setState(() {
      ...
      widget.pageName = 'Helpdesk Summary';
    });
            ...
            Padding(
              ...
              child: Row(
                ...
                children: const [
                  Flexible(
                    flex: 2,
                    child: Text(' HelpDesk Month Wise Status',
